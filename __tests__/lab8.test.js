describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const buyButton = await shadowRoot.$("button");

    //console.log("button:", buyButton);
    // Once you have the button, you can click it and check the innerText property of the button.
    await buyButton.click();

    const buttonTextProperty = await buyButton.getProperty("innerText");

    //console.log("buttonTextProperty:", buttonTextProperty);
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    const cartCountInnerTextVal = await cartCountInnerText.jsonValue();

    expect(cartCountInnerTextVal).toBe("20");
  }, 10000);
  ...
  it('Checking number of items in cart on screen after removing from cart', async () => {
    ...
    expect(cartCountInnerTextVal).toBe("0");
  }, 10000);
